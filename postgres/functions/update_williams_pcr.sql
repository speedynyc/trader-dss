...
AS $$
    ...
    wpr100 RECORD;
    wpr200 RECORD;
    wpr10n indicators.wpr_10%TYPE;
    wpr10d indicators.wpr_10%TYPE;
    wpr10v indicators.wpr_10%TYPE;
    wpr20n indicators.wpr_10%TYPE;
    wpr20d indicators.wpr_10%TYPE;
    wpr20v indicators.wpr_10%TYPE;
    wpr30n indicators.wpr_10%TYPE;
    wpr30d indicators.wpr_10%TYPE;
    wpr30v indicators.wpr_10%TYPE;
    wpr50n indicators.wpr_10%TYPE;
    wpr50d indicators.wpr_10%TYPE;
    wpr50v indicators.wpr_10%TYPE;
    wpr100n indicators.wpr_10%TYPE;
    wpr100d indicators.wpr_10%TYPE;
    wpr100v indicators.wpr_10%TYPE;
    wpr200n indicators.wpr_10%TYPE;
    wpr200d indicators.wpr_10%TYPE;
    wpr200v indicators.wpr_10%TYPE;
    BEGIN
