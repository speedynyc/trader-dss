...
function create_add_form()
{
    ...
    $create_pf_form->addElement('text', 'sell_stop', 'Sell stop limit:', array('size' => 10, 'maxlength' => 10));
...
function create_portfolio($form)
{
    ...
    try{
        ...
        $query = "insert into portfolios (name, uid, exch, opening_balance, parcel, working_date, hide_names, sell_stop, auto_sell_stop, tax_rate, commission) values ($pf_desc, '$uid', '$exch', $opening_balance, $parcel, '$start_date', '$hide', '$sell_stop', '$auto', '$tax_rate', '$commission');";
        $pdo->exec($query);
