...
# $holdings{"symb,exch"}{qty} = quantity held
...
# buy criteria
my $buy_fields = "date, symb, close, $buy_ma_to_use,  \"close\" - $buy_ma_to_use as close_ma_diff, volume_sd_50";
my $where_clause = "close < $parcel and exch = \'$exch\' and volume_sd_50 > 2";
my $order_clause = 'volume_sd_50 desc';
# sell criteria
