# This application is written using CodeIgniter as a MCV framework.
# a minimimal number of customised CodeIgniter files are included in the distribution and they are covered by the following license
