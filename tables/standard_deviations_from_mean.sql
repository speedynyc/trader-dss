...
(
 ...
 close_sd_10 numeric(9,4), -- The standard deviation of the close price over the last 10 days
 close_sd_20 numeric(9,4), -- The standard deviation of the close price over the last 20 days
 close_sd_30 numeric(9,4), -- The standard deviation of the close price over the last 30 days
 close_sd_50 numeric(9,4), -- The standard deviation of the close price over the last 50 days
 close_sd_100 numeric(9,4), -- The standard deviation of the close price over the last 100 days
 close_sd_200 numeric(9,4), -- The standard deviation of the close price over the last 200 days
 volume_sd_10 numeric(9,4), -- The standard deviation of the volume over the last 10 days
 volume_sd_20 numeric(9,4), -- The standard deviation of the volume over the last 20 days
 volume_sd_30 numeric(9,4), -- The standard deviation of the volume over the last 30 days
 volume_sd_50 numeric(9,4), -- The standard deviation of the volume over the last 50 days
 volume_sd_100 numeric(9,4), -- The standard deviation of the volume over the last 100 days
 volume_sd_200 numeric(9,4)  -- The standard deviation of the volume over the last 200 days
 )
WITHOUT OIDS;
