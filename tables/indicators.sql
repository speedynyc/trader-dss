...
(
 ...
 mapr_10 numeric(9,2), -- moving_averages.ma_10_sum / moving_averages.ma_10_run. It provides a sortable measure of the stock against it's 10 day moving average.
 mapr_20 numeric(9,2), -- moving_averages.ma_20_sum / moving_averages.ma_20_run. It provides a sortable measure of the stock against it's 20 day moving average.
 mapr_30 numeric(9,2), -- moving_averages.ma_30_sum / moving_averages.ma_30_run. It provides a sortable measure of the stock against it's 30 day moving average.
 mapr_50 numeric(9,2), -- moving_averages.ma_50_sum / moving_averages.ma_50_run. It provides a sortable measure of the stock against it's 50 day moving average.
 mapr_100 numeric(9,2), -- moving_averages.ma_100_sum / moving_averages.ma_100_run. It provides a sortable measure of the stock against it's 100 day moving average.
 mapr_200 numeric(9,2), -- moving_averages.ma_200_sum / moving_averages.ma_200_run. It provides a sortable measure of the stock against it's 200 day moving average.
 mcad numeric(9,2), 
 mcad_signal numeric(9,2), 
 mcad_histogram numeric(9,2), 
