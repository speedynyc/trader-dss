...
BEGIN
    ...
    ELSE
        ...
        -- gain1
        select topN.date, topN.symb, topN.exch, topN.close into gain1 from (select date, symb, exch, close from quotes where symb = new_symb and exch = new_exch and date < new_date order by date desc limit 1) as topN;
